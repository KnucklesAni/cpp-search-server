...
public:
  ...
  friend void AddDocument(SearchServer &search_server, int document_id,
                          const std::string &document, DocumentStatus status,
                          const std::vector<int> &ratings) {
    return search_server.AddDocument(document_id, document, status, ratings);
  }
  friend void RemoveDocument(SearchServer &search_server, int document_id) {
    return search_server.RemoveDocument(document_id);
  }
